...
object CaseClassDB{
  ...
  final case class Straordinari(data:Date,personaId:Int,turnoId:Int,idStraordinario:Option[Int]=None)
  ...
  final case class Settimane(parametriSetId:Int,idZone:Option[Int]=None)
  ...
  final case class Parametri(treSabato:Byte,Regola:String,idParametri:Option[Int]=None)
  final case class GruppiTerminali(parametriId:Int,idGruppoTerminale:Option[Int]=None)
